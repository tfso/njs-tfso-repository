...
describe("When using WhereOperator", () => {
    ...
    it("should get union expression properties", () => {
        let where = new whereoperator_1.WhereOperator('Javascript', car => (car.registrationYear == 2015 && car.location == 'NO') || car.registrationYear == 2015 || (car.location == 'SE' && car.registrationYear == 2015)), intersection = where.getExpressionUnion();
        assert.equal(intersection.length, 5, "Expected 5 expression from union");
    });
    it("should get expression groups", () => {
        let where = new whereoperator_1.WhereOperator('Javascript', car => (car.registrationYear == 2015 && car.location == 'NO') || car.registrationYear == 2015 || (car.location == 'SE' && car.registrationYear == 2015)), groups = Array
