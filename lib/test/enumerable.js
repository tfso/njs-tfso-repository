...
describe("When using Enumerable", () => {
    ...
    describe("with async iterable", () => {
        ...
        it("should be able to handle list of items", () => __awaiter(this, void 0, void 0, function* () {
            let hasItems = false;
            try {
                for (var _a = __asyncValues(new enumerable_1.default(list()).where(it => it.id == 3)), _b; _b = yield _a.next(), !_b.done;) {
                    let item = yield _b.value;
                    hasItems = true;
        ...
        it("should be able to handle list of promises", () => __awaiter(this, void 0, void 0, function* () {
            let hasItems = false;
            try {
                for (var _a = __asyncValues(new enumerable_1.default(list()).where(it => it.id == 5)), _b; _b = yield _a.next(), !_b.done;) {
                    let item = yield _b.value;
                    hasItems = true;
