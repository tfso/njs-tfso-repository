...
class SelectOperator extends operator_1.Operator {
    constructor(selector) {
        super(operator_1.OperatorType.Select);
        ...
        return __asyncGenerator(this, arguments, function* evaluateAsync_1() {
            ...
            try {
                for (var items_1 = __asyncValues(items), items_1_1; items_1_1 = yield __await(items_1.next()), !items_1_1.done;) {
                    ...
                    yield yield __await(this.selector(item));
                }
            }
...
//# sourceMappingURL=selectoperator.js.map