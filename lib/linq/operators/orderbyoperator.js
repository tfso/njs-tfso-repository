...
exports.OrderByOperator = void 0;
...
class OrderByOperator extends operator_1.Operator {
    constructor(property) {
        ...
        if (typeof property == 'function') {
            let expression = new expressionvisitor_1.ExpressionVisitor().visitLambda(property);
            if (expression.type != expressionvisitor_1.ExpressionType.Member)
                throw new TypeError('Order by is expecting a member property as sorting property');
            if (expression.property.type != expressionvisitor_1.ExpressionType.Identifier)
                throw new TypeError('Order by is expecting a member property as sorting property');
            this.property = expression.property.name;
        }
        else {
