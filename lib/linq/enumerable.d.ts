...
export declare class Enumerable<TEntity> implements IEnumerable<TEntity> {
    ...
    get name(): string;
    get operations(): Operations<TEntity>;
    /**
     * A remapper of identifier names, members is seperated with dot.
     * @param remapper Function that returns the new name of the identifier
     */
    remap<TResult>(remapper: (name: string) => string): Enumerable<TResult>;
    /**
     * A remapper of values that corresponds to a identifier name
     * @param remapper Function that returns the new value
     */
    remap<TResult>(remapper: (name: string, value: any) => any): Enumerable<TResult>;
    /**
     * Where clause using OData $filter expression returning either true or false. Any parameters used is properties of TEntity
     * @param predicate OData expression
     */
    ...
    * @param selector
    */
    select<TResult>(selector: (it: TEntity) => TResult): Enumerable<TResult>;
    select<TResult extends Partial<TEntity>>(selector: string): Enumerable<TResult>;
    /**
     * returns a new IEnumerable of TResult (Left Join)
     * @param inner
     * @param outerKey
     ...
     * @returns IEnumerable<TResult>
     */
    groupJoin<TInner, TResult>(inner: Iterable<TInner>, outerKey: (outer: TEntity) => void, innerKey: (inner: TInner) => void, selector: (outer: TEntity, inner: IEnumerable<TInner>) => TResult, indexing?: boolean): Enumerable<TResult>;
    /**
     * returns a new IEnumerable of TResult (Left Join)
     * @param inner
     * @param outerKey
     ...
     * @returns IEnumerable<TResult>
     */
    groupJoin<TInner, TResult>(inner: AsyncIterable<TInner>, outerKey: (outer: TEntity) => void, innerKey: (inner: TInner) => void, selector: (outer: TEntity, inner: IEnumerable<TInner>) => TResult, indexing?: boolean): Enumerable<TResult>;
    /**
     * returns a new IEnumerable of TResult (Inner Join)
     * @param inner
     * @param outerKey
     ...
     * @returns IEnumerable<TResult>
     */
    join<TInner, TResult>(inner: Iterable<TInner>, outerKey: (outer: TEntity) => void, innerKey: (inner: TInner) => void, selector: (outer: TEntity, inner: IEnumerable<TInner>) => TResult, indexing?: boolean): Enumerable<TResult>;
    /**
     * returns a new IEnumerable of TResult (Inner Join)
     * @param inner
     * @param outerKey
     ...
     * @returns IEnumerable<TResult>
     */
    join<TInner, TResult>(inner: AsyncIterable<TInner>, outerKey: (outer: TEntity) => void, innerKey: (inner: TInner) => void, selector: (outer: TEntity, inner: IEnumerable<TInner>) => TResult, indexing?: boolean): Enumerable<TResult>;
    /**
     * Returns a specified number of contiguous elements from the start of a sequence.
     * @param count The number of elements to return
     */
