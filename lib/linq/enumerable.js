...
exports.Enumerable = exports.OperatorType = void 0;
const operator_1 = require("./operators/operator");
Object.defineProperty(exports, "OperatorType", { enumerable: true, get: function () { return operator_1.OperatorType; } });
        ...
        for (let item of this._operations.values()) {
            switch (item.type) {
                case operator_1.OperatorType.Where:
                    ...
                    break;
                case operator_1.OperatorType.OrderBy:
